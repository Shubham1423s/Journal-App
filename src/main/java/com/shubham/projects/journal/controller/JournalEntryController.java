...
import com.shubham.projects.journal.service.JournalEntryService;
...
//        }
    ...
    @PutMapping("id/{id}")
    public ResponseEntity<?> updateById(@RequestBody JournalEntry newEntry,@PathVariable ObjectId id ){
        ...
        if(!collect.isEmpty()){
            Optional<JournalEntry> journalEntry = journalEntryService.getEntry(id);
            if(journalEntry.isPresent()){
